...
{
    public partial class KitapEmanetListe : Form
    {
        public KitapEmanetListe()
        {
            InitializeComponent();
        }

        kitapAlimIade iade_alim = new kitapAlimIade();
        ...
        private void btnArama_Click(object sender, EventArgs e)
        {
            ...
            try //hatali olabilecek kodlar
            {
                ...
                List<iadeVarlik> kayit_cekme = iade_alim.kayit_listeleme2(kitapBilgi_txt.Text, konum);
        ...
        private void btnKayit_Click(object sender, EventArgs e)
        {
            ...
            List<iadeVarlik> kitap = iade_alim.iade_alim_yukle();
